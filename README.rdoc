...
6) start the web server at port 3000:
       rails server -p3000 (run with --help for options)

7) Go to http://localhost:3000/ and you'll see:
       "Badal Karkhana!"

8) [deploy using capistrano](http://guides.beanstalkapp.com/deployments/deploy-with-capistrano.html#install-capistrano)
       $ capify .
       [add] writing './Capfile'
...
9) Follow the guidelines to start developing your application. You can find the following resources handy:

* The Getting Started Guide: http://guides.rubyonrails.org/getting_started.html
* Ruby on Rails Tutorial Book: http://www.railstutorial.org/

![Karkhana Snapshot](https://github.com/iPrayag/badal-karkhana/raw/master/badal-karkhana-prayagupd.png)
